...
export function ExternalLinkIcon(props: IconProps): JSX.Element {
  const size = props.size ?? 16
  return (
    <svg width={size} height={size} className={props.className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SortIcon(props: IconProps): JSX.Element {
  ...
  return (
    <svg width={size} height={size} className={props.className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 6h12M3 12h9M3 18h6M17 8l4-4 4 4M21 4v16" transform="translate(-2 0)" />
    </svg>
  )
}
...
export function MoreIcon(props: IconProps): JSX.Element {
  const size = props.size ?? 16
  return (
    <svg width={size} height={size} className={props.className} viewBox="0 0 24 24" fill="currentColor" stroke="none">
