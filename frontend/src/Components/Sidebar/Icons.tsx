...
function base(props: IconProps): { width: number; height: number; className?: string } {
...
export function ChevronIcon(props: IconProps): JSX.Element {
  return (
    <svg {...base({ size: 12, ...props })} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
