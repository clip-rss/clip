...
describe('SidebarStore', () => {
  ...
  it('setFeedSort 更新排序方式', () => {
    ...
    useSidebarStore.getState().setFeedSort('unreadAsc')
    expect(useSidebarStore.getState().feedSort).toBe('unreadAsc')
    useSidebarStore.getState().setFeedSort('unreadDesc')
    expect(useSidebarStore.getState().feedSort).toBe('unreadDesc')
